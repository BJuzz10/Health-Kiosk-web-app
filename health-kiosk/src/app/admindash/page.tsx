...
export default function DoctorsHomePage() {
  ...
  const translations = {
    ...
    personalInfo: isEnglish ? "Doctor's Personal Information" : "Personal na Impormasyon ng Doktor",
    startAppointments: isEnglish ? "Start Health Kiosk Appointments" : "Simulan ang Health Kiosk Appointment",
