      ...
      <main className="pt-16">
        ...
        <div className="flex flex-col lg:flex-row items-start justify-center p-4 md:p-8 gap-12">
          <div className="flex flex-col space-y-4 max-w-sm lg:max-w-xs">
            <p className="text-3xl font-bold text-gray-700 text-center lg:text-left lg:mx-0 mx-8">
              Who Are We?
            </p>
          </div>
          <div className="max-w-2xl space-y-4">
            <p className="text-lg text-gray-800 lg:text-justify text-center">
              We are a team of dedicated students from Batangas State
              University, working together to create innovative solutions that
              improve healthcare accessibility for underserved communities,
              particularly in the Geographically Isolated and Disadvantaged
              Areas (GIDA) of Batangas Province.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between p-4 md:p-8 gap-12">
          <div className="flex-1 space-y-4 text-center lg:text-left">
            <p className="text-3xl font-bold text-gray-700">
              Innovative Integration of Health Monitoring Tools
            </p>
            <p className="text-lg text-gray-800 lg:text-justify">
              Our web application empowers individuals to check vital health
              metrics easily.
            </p>
          </div>
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center justify-between p-4 md:p-8 gap-12">
          <div className="flex-1 space-y-4 text-center lg:text-left">
            ...
            <p className="text-lg text-gray-800 lg:text-justify">
              Our system transforms remote healthcare delivery, putting
              essential information within the reach of those who need it most.
            </p>
          </div>
          <div className="flex-1 w-[400px] h-[400px]">
            <Image
          ...
          <div className="flex flex-col items-center justify-center min-h-[40vh] p-6">
            <div className="flex flex-col md:flex-row w-full max-w-6xl justify-between gap-8 text-center md:text-left">
              <div className="flex-1 flex flex-col items-center md:items-start justify-center">
                ...
                <p>
                  To create a future where every community, regardless of
                  distance or economic status, has access to primary healthcare
                  through innovative biomedical technologies.
                </p>
              </div>
              ...
              <div className="flex-1 flex flex-col items-center md:items-start justify-center">
                ...
                <p>
                  To develop an accessible and reliable digital health system
                  that empowers marginalized communities with vital healthcare
        ...
        <div className="w-full px-6 py-10 bg-white text-center">
          ...
          <p className="max-w-4xl mx-auto mb-10 text-gray-700">
            This project is a collaboration between Biomedical Engineering
            students from Batangas State University – Alangilan Campus and
            College of Medicine students from Batangas State University - Pablo
            Borbon Campus. Our interdisciplinary team combines technical
            innovation with clinical insight, guided by our shared commitment to
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            <Card>
              <CardContent className="p-4 flex flex-col items-center text-center">
                ...
                <p className="text-sm text-gray-600">
                  Project Leader of the Biomedical Engineering Team
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-4 flex flex-col items-center text-center">
                ...
                <p className="text-sm text-gray-600">
                  Project Member of the Biomedical Engineering Team
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-4 flex flex-col items-center text-center">
                ...
                <p className="text-sm text-gray-600">
                  Project Leader of the College of Medicine Team
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-4 flex flex-col items-center text-center">
                ...
                <p className="text-sm text-gray-600">
                  Project Member of the College of Medicine Team
                </p>
              </CardContent>
            </Card>
